...
These excercises will walk through the steps of defining and generating cohorts using the `Capr` and `CohortGenerator` packages. For more information, go to the package website:
