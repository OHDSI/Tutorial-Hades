...
2.  During which period in time (calender start and end date) did people start a celecoxib prescription?

3.  How many people have at least one prescription of celecoxib. (Note: there's an easy way to do this, using `drug_era`, and a harder way using `drug_exposure` and `concept_ancestor`. Can you do both?
